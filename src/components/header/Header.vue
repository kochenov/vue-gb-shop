  ...
  <header class="header">
    <div class="container header-wrapper">
      ...
      <ul class="header-col-right">
        ...
        <li class="sm-hidden">
          <a
            @click.prevent="this.$root.cartOn = !this.$root.cartOn"
            class="header-col-right__cart-link"
            href="#"
            ><svg
              width="32"
              height="29"
            ...
            >
              ...
              ></path></svg
            ><span class="header-col-right__count-product">{{
              cartInfo.countProductsInCart
            }}</span></a
          >
        </li>
      </ul>
      <Cart :cartOn="this.$root.cartOn" :products="cart" :cartInfo="cartInfo"/>
    </div>
  </header>
...
export default {
  props: { cart: Array, cartInfo: Object },
  data() {
    return {
      cartStatus: false,
      onMenu: false,
...
// Правая колонка шапки сайта
.header-col-right {
  display: flex;
  align-items: center;

  // Обёртка для кнопки открытия меню
  &__menu-button-wrap {
